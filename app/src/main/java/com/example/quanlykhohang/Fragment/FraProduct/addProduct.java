...
public class addProduct extends Fragment implements EasyPermissions.PermissionCallbacks {
    public static final String TAG = addProduct.class.getName();
        ...
        try {
            ...
            if (tensp.isEmpty() || giasp.isEmpty() || soluong.isEmpty() || hinhanhSP.isEmpty()) {
                ...
                try {
                    ...
                    var check = dao.insertProduct(pr);
                    if (check) {
